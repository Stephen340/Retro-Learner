...
from SonicToMario import cumulative_reward
...
class DQN:
    ...
    def train_episode(self):
        ...
        for _ in range(131072):  # Self.options.steps
            ...
            full_reward += reward
            # print(reward)
            rewards_per_episode.append(full_reward)
...
for i in range(40000):
    ...
    dqn.save_model("mario_to_sonic_pretrained.pth")
    ...
    if i % 100 == 0 and i != 0:
        ...
        plt.legend()
        plt.grid()
        plt.savefig('mario_pretrained_to_sonic_episode_rewards.png')
        plt.close()
    ...
    if i % 100 == 0 and i != 0:
        ...
        plt.legend()
        plt.grid()
        plt.savefig('mario_pretrained_to_sonic_cumulative_rewards.png')
        plt.close()
